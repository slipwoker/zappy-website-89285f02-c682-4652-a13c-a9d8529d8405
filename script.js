    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רענן קמינים ושרותי גז משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '89285f02-c682-4652-a13c-a9d8529d8405',
                    name: data.name || '',
                    email: data.email || '',
